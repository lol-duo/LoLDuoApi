...
public class DetailService {
    ...
    public ResponseEntity<?> getSoloChampionDetail(Long soloMatchId){
        log.info("요청 soloMatchId : {}", soloMatchId);
        ...
        log.info("검색할 championCombId : {}", championCombId);
        ...
        if(soloMatchDetailEntityList == null || soloMatchDetailEntityList.size() == 0){
    ...
    public ResponseEntity<?> getDoubleChampionDetail(Long doubleMatchId){
        ...
        if(doubleMatchDetailEntityList == null || doubleMatchDetailEntityList.size() == 0){
