...
public interface ICombinationInfoRepository {
    Optional<? extends List<? extends ICombinationInfoEntity>> findAllByChampionIdAndPositionDesc(String championId, String position);
    Optional<? extends List<? extends ICombinationInfoEntity>> findAllByChampionIdAndPositionAsc(String championId, String position);
